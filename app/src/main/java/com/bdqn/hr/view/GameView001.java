...
public class GameView001 extends View implements Runnable {
    ...
    ActorInfoListener mActorInfoListener;
    ...
    protected void onDraw(Canvas canvas) {
        if (bgPaint) {
            ...
            this.canvas.drawBitmap(mtTextImgbg, 0, 605, paint);
            //绘制bg2图
        ...
        //绘制玩家信息
        if (mActorInfoListener != null) {
            mActorInfoListener.setActorInfo();
        }
//        actor.drawActorInfo(canvas);
    ...
    public interface ActorInfoListener {
        void setActorInfo();
    }

    public void setActorInfoListener(ActorInfoListener listener) {
        mActorInfoListener = listener;
    }
